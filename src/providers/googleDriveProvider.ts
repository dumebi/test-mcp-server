  ...
  private getAuthUrl(): string {
    ...
    return this.auth.generateAuthUrl({
      ...
      scope: [
        ...
        "https://www.googleapis.com/auth/meetings	", // Access Google Meet
      ],
    ...
    return [
      {
        ...
        description: 'List files from Google Drive. Default query is "trashed = false".',
        inputSchema: {
          type: "object",
          properties: {
            query: {
              type: 'string',
              description: "Search query (e.g., 'name contains \"report\"', 'mimeType=\"image/jpeg\"')",
            ...
            orderBy: {
              type: 'string',
              description: "Field(s) to sort by (e.g., 'modifiedTime desc', 'name')",
              default: 'modifiedTime desc',
            },
            fields: {
              type: 'string',
              description: "Fields to include in the response (default: 'files(id, name, mimeType, modifiedTime, size, webViewLink)')",
